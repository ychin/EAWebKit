...
#else
    iReturn = DirtyWebApiRequest(pRef->pWebApi, (int32_t)pCurrent->uUserIndex, USERLISTAPI_API_GROUP, SCE_NP_WEBAPI2_HTTP_METHOD_GET, requestPath, NULL, 0, NULL, &_DirtyWebApiCallback, pRef);
#endif
...
#else
static void _UserListOnWebApiUpdate(int32_t userCtxId, int32_t callbackId, const char *pNpServiceName, SceNpServiceLabel npServiceLabel, const SceNpPeerAddressA *pTo, const SceNpPeerAddressA *pFrom, const SceNpWebApi2PushEventDataType *pDataType, const char *pData, size_t dataLen, void *pUserArg)
#endif
{
