...
#if 1 /*defined TT_CONFIG_OPTION_POSTSCRIPT_NAMES*/ // EA CHANGE: this #if define guard seems incorrect as TT vs FT postscript functions are supposed to be exclusive but there is a mix inherent in the current implementation
