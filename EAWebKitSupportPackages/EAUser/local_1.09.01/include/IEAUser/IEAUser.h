...
namespace EA
{
	...
	namespace User
	{
		...
		public:
			...
			virtual bool								RequestUserRealName(RealNameCallback callback) const { return false; }
			virtual void								AbortUserRealNameRequest() const {}

			virtual bool								RequestGamerpic(GamerPicCallback callback) const { return false; }
			...
			void SetUserInstance(IEAUser* pInstance) {}
			void DestroyThis() {}
