...
int TestCpuAvailableAffinityMask()
{
	...
	// Test parseSet()
	{
		...
		EA::Thread::ThreadAffinityMask parseSetResult1 = parseSet(parseSetTest1, strlen(parseSetTest1));
		EA::Thread::ThreadAffinityMask parseSetResult2 = parseSet(parseSetTest2, strlen(parseSetTest2));
		EA::Thread::ThreadAffinityMask parseSetResult3 = parseSet(parseSetTest3, strlen(parseSetTest3));
