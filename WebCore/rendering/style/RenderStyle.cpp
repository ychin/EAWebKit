...
void RenderStyle::setContent(PassRefPtr<StyleImage> image, bool add)
{
	...
	//+EAWebKitChange
	//3/12/2014
	std::unique_ptr<ContentData> tempVal = std::make_unique<ImageContentData>(image);
	rareNonInheritedData.access()->m_content = std::move(tempVal);
...
void RenderStyle::setContent(const String& string, bool add)
{
	...
	//+EAWebKitChange
	//3/12/2014
	std::unique_ptr<ContentData> tempVal = std::make_unique<TextContentData>(string);
	content = std::move(tempVal);
...
void RenderStyle::setContent(std::unique_ptr<CounterContent> counter, bool add)
{
	...
	//+EAWebKitChange
	//3/12/2014
	std::unique_ptr<ContentData> tempVal = std::make_unique<CounterContentData>(std::move(counter));
	rareNonInheritedData.access()->m_content = std::move(tempVal);
...
void RenderStyle::setContent(QuoteType quote, bool add)
{
	...
	//+EAWebKitChange
	//3/12/2014
	std::unique_ptr<ContentData> tempVal = std::make_unique<QuoteContentData>(quote);
	rareNonInheritedData.access()->m_content = std::move(tempVal);
