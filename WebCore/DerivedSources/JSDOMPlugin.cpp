...
{
    { "item", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsDOMPluginPrototypeFunctionItem), (intptr_t)0 },
    { "namedItem", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsDOMPluginPrototypeFunctionNamedItem), (intptr_t)0 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
JSValue jsDOMPluginConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSDOMPlugin::getConstructor(exec->vm(), domObject->globalObject());
}
...
EncodedJSValue JSC_HOST_CALL jsDOMPluginPrototypeFunctionItem(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSDOMPlugin::info()))
...
{
    return value.inherits(JSDOMPlugin::info()) ? &jsCast<JSDOMPlugin*>(asObject(value))->impl() : 0;
}
