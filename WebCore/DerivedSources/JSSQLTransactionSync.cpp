...
{
    { "executeSql", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsSQLTransactionSyncPrototypeFunctionExecuteSql), (intptr_t)2 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
EncodedJSValue JSC_HOST_CALL jsSQLTransactionSyncPrototypeFunctionExecuteSql(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSSQLTransactionSync::info()))
...
{
    return value.inherits(JSSQLTransactionSync::info()) ? &jsCast<JSSQLTransactionSync*>(asObject(value))->impl() : 0;
}
