...
{
    { "clearData", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsClipboardPrototypeFunctionClearData), (intptr_t)0 },
    { "getData", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsClipboardPrototypeFunctionGetData), (intptr_t)1 },
    { "setData", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsClipboardPrototypeFunctionSetData), (intptr_t)2 },
    { "setDragImage", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsClipboardPrototypeFunctionSetDragImage), (intptr_t)3 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
JSValue jsClipboardConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSClipboard::getConstructor(exec->vm(), domObject->globalObject());
}
...
EncodedJSValue JSC_HOST_CALL jsClipboardPrototypeFunctionClearData(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSClipboard::info()))
...
{
    return value.inherits(JSClipboard::info()) ? &jsCast<JSClipboard*>(asObject(value))->impl() : 0;
}
