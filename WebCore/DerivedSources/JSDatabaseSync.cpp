...
{
    { "changeVersion", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsDatabaseSyncPrototypeFunctionChangeVersion), (intptr_t)2 },
    { "transaction", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsDatabaseSyncPrototypeFunctionTransaction), (intptr_t)1 },
    { "readTransaction", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsDatabaseSyncPrototypeFunctionReadTransaction), (intptr_t)1 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
EncodedJSValue JSC_HOST_CALL jsDatabaseSyncPrototypeFunctionChangeVersion(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSDatabaseSync::info()))
...
{
    return value.inherits(JSDatabaseSync::info()) ? &jsCast<JSDatabaseSync*>(asObject(value))->impl() : 0;
}
