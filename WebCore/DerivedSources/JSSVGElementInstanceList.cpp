...
{
    { "item", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsSVGElementInstanceListPrototypeFunctionItem), (intptr_t)0 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
JSValue jsSVGElementInstanceListConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSSVGElementInstanceList::getConstructor(exec->vm(), domObject->globalObject());
}
...
EncodedJSValue JSC_HOST_CALL jsSVGElementInstanceListPrototypeFunctionItem(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSSVGElementInstanceList::info()))
...
{
    return value.inherits(JSSVGElementInstanceList::info()) ? &jsCast<JSSVGElementInstanceList*>(asObject(value))->impl() : 0;
}
