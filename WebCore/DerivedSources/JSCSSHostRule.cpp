...
{
    { "insertRule", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsCSSHostRulePrototypeFunctionInsertRule), (intptr_t)0 },
    { "deleteRule", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsCSSHostRulePrototypeFunctionDeleteRule), (intptr_t)0 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
JSValue jsCSSHostRuleConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSCSSHostRule::getConstructor(exec->vm(), domObject->globalObject());
}
...
EncodedJSValue JSC_HOST_CALL jsCSSHostRulePrototypeFunctionInsertRule(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSCSSHostRule::info()))
