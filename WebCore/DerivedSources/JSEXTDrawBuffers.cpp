...
static const HashTableValue JSEXTDrawBuffersPrototypeTableValues[] =
{
    ...
    { "drawBuffersEXT", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsEXTDrawBuffersPrototypeFunctionDrawBuffersEXT), (intptr_t)1 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
EncodedJSValue JSC_HOST_CALL jsEXTDrawBuffersPrototypeFunctionDrawBuffersEXT(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSEXTDrawBuffers::info()))
...
{
    return value.inherits(JSEXTDrawBuffers::info()) ? &jsCast<JSEXTDrawBuffers*>(asObject(value))->impl() : 0;
}
