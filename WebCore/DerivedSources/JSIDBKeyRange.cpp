...
{
    { "only", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsIDBKeyRangeConstructorFunctionOnly), (intptr_t)1 },
    { "lowerBound", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsIDBKeyRangeConstructorFunctionLowerBound), (intptr_t)1 },
    { "upperBound", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsIDBKeyRangeConstructorFunctionUpperBound), (intptr_t)1 },
    { "bound", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsIDBKeyRangeConstructorFunctionBound), (intptr_t)2 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
JSValue jsIDBKeyRangeConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSIDBKeyRange::getConstructor(exec->vm(), domObject->globalObject());
}
...
EncodedJSValue JSC_HOST_CALL jsIDBKeyRangeConstructorFunctionUpperBound(ExecState* exec)
{
    ...
    if (!scriptContext)
        return JSValue::encode(jsUndefined());
    ScriptValue upper(exec->vm(), exec->argument(0));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
{
    return value.inherits(JSIDBKeyRange::info()) ? &jsCast<JSIDBKeyRange*>(asObject(value))->impl() : 0;
}
