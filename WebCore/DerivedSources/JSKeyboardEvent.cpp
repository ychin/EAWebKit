...
static const HashTableValue JSKeyboardEventPrototypeTableValues[] =
{
    ...
    { "DOM_KEY_LOCATION_RIGHT", DontDelete | ReadOnly, NoIntrinsic, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsKeyboardEventDOM_KEY_LOCATION_RIGHT), (intptr_t)0 },
    { "DOM_KEY_LOCATION_NUMPAD", DontDelete | ReadOnly, NoIntrinsic, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsKeyboardEventDOM_KEY_LOCATION_NUMPAD), (intptr_t)0 },
    { "initKeyboardEvent", DontDelete | JSC::Function, NoIntrinsic, (intptr_t)static_cast<NativeFunction>(jsKeyboardEventPrototypeFunctionInitKeyboardEvent), (intptr_t)0 },
    { 0, 0, NoIntrinsic, 0, 0 }
};
...
JSValue jsKeyboardEventConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSKeyboardEvent::getConstructor(exec->vm(), domObject->globalObject());
}
...
EncodedJSValue JSC_HOST_CALL jsKeyboardEventPrototypeFunctionInitKeyboardEvent(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSKeyboardEvent::info()))
