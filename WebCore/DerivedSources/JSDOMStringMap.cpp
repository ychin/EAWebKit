...
JSValue jsDOMStringMapConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSDOMStringMap::getConstructor(exec->vm(), domObject->globalObject());
}
...
{
    return value.inherits(JSDOMStringMap::info()) ? &jsCast<JSDOMStringMap*>(asObject(value))->impl() : 0;
}
