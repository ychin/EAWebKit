...
static const HashTableValue JSAudioTrackTableValues[] =
{
    ...
    { "kind", DontDelete | ReadOnly, NoIntrinsic, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsAudioTrackKind), (intptr_t)0 },
    { "label", DontDelete | ReadOnly, NoIntrinsic, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsAudioTrackLabel), (intptr_t)0 },
    { "language", DontDelete | ReadOnly, NoIntrinsic, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsAudioTrackLanguage), (intptr_t)0 },
...
{
    return value.inherits(JSAudioTrack::info()) ? &jsCast<JSAudioTrack*>(asObject(value))->impl() : 0;
}
